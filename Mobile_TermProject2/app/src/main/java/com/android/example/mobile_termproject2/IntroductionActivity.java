...
public class IntroductionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //이미지 및 TTS 설정
        lay=findViewById(R.id.howToUse);
        TextView textPlan = findViewById(R.id.textViewPlan);
        TTS_text = textPlan.getText().toString();
        tts();
        // RecognizerIntent 생성
        ...
        mRecognizer = SpeechRecognizer.createSpeechRecognizer(IntroductionActivity.this); // 새 SpeechRecognizer 를 만드는 팩토리 메서드
        mRecognizer.setRecognitionListener(listener); // 리스너 설정

//이미지 클릭시 TTS,STT설정
        textPlan.setOnClickListener(new View.OnClickListener() {
            @Override
